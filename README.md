...
|----|-----|----|---|---|
| [ciclo](https://github.com/guionardo/ciclo) | ciclo — framework de IA para o ciclo de desenvolvimento (tasks → spec → código → review → deploy) | <span><a href="https://api.github.com/repos/guionardo/ciclo/git/commits/dac90cda282932de7713acc45373565c847c6e68" title="Guionardo Furlan @ 2026-09-04 14:34:22+00:00"><small>dac90cda</small></a><pre>fix(postinstall): remove || true for Windows compatibility</pre></span> | <span title="🚀 Recently Active">🚀</span>|JavaScript, Shell, Makefile
